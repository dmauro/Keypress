...
(function() {
  ...
  demos = {
    ...
    demo_2: {
      wire: function() {
        keypress.keyup_combo("w", function() {
          return console.log("N");
        });
        keypress.keyup_combo("a", function() {
          return console.log("W");
        });
        keypress.keyup_combo("s", function() {
          return console.log("S");
        });
        keypress.keyup_combo("d", function() {
          return console.log("E");
        });
        keypress.keyup_combo("w a", function() {
          return console.log("NW");
        });
        keypress.keyup_combo("w d", function() {
          return console.log("NE");
        });
        keypress.keyup_combo("s a", function() {
          return console.log("SW");
        });
        return keypress.keyup_combo("s d", function() {
          return console.log("SE");
        });
      },
      unwire: function() {
        return keypress.unregister_many(["w", "a", "s", "d", "w a", "w d", "s a", "s d"]);
      }
    },
    demo_3: {
      wire: function() {},
  ...
  get_active_demo = function() {
    return $('.examples .demo').each(function(_, node) {
      node = $(node);
