...
(function() {
  var bind_fake_keyboard, fake_keyboard_combos, key_nodes;

  fake_keyboard_combos = [];

  key_nodes = {};

  bind_fake_keyboard = function() {
    var keys, on_down, on_shift_down, on_shift_up, on_up;
    keys = $('.keyboard .key');
