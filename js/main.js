...
(function() {
  var activate_demo, bind_demos, bind_keyboard, combo, demo_2, demo_3, demo_4, demos, get_active_demo, unwire_demo, wire_demo, _i, _len, _ref;
  ...
  bind_keyboard = function() {
    var combos, key_nodes, keyboard_msg_node, keys, on_down, on_shift_down, on_shift_up, on_up, _j, _len1;
    ...
    for (_j = 0, _len1 = combos.length; _j < _len1; _j++) {
      combo = combos[_j];
      combo['allow_default'] = true;
    }
  ...
  bind_demos = function() {
    return $('body').delegate('a.demo_link', 'click', function() {
      var demo;
      demo = $(this).data("demo");
